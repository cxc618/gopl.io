...
func main() {
	...
	issues, _, _ := client.IssueService.ListByRepo("cxc618", "android-async-http", params)
	...
	accessToken := flags.String("access-token", "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", "Github Access Token")
